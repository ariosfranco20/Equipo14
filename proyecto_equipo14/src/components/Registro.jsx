                        ...
                        <div className="">
                            <form onSubmit={handleSubmit(customSubmit)}>
                                <div className="mb-3 row">
                                    ...
                                    />
                                    {errors.usuario && <small><p>Campo requerido - Sin espacios - Sin caracteres especiales (-*/+.;:) - Solo letras (ABC), con 5 caracteres como minimo y 10 como maximo</p></small>}
                                    </div>
                                </div>
                                <div className="mb-3 row">
                                    <label htmlFor="contraseña" className="col-4 col-form-label">Contraseña</label>
                                    <div className="col-8">
                                    <input 
                                        type="password" 
                                        className="form-control" 
